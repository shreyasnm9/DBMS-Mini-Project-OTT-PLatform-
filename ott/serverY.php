...
if(isset($_POST['SignUpY']))
{
    //echo "Inside";
        ...
        values('$User_name','$Full_name','$email','$phone','$userpassword','$age','$country','Y001')";
        $sql_query_check = "SELECT * from customer where Username = '$User_name'";
        $result1 = mysqli_query($conn, $sql_query_check);
        $num= mysqli_num_rows($result1);
        if($num >0){
            echo "Username Already exists <br>";
            echo "If you are a new user: <a href = 'signupyearly.php'>Try Again</a>";
            exit;
        }
