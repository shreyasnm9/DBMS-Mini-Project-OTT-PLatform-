...
$stmt = $conn->prepare("CALL SP_hintv()");
$stmt->execute();
...
if ($stmt->num_rows > 0) {
    ...
    while($stmt->fetch()) {
        ...
        echo "<tr>";
        echo "<td style='border: 0px solid black;'><a href='http://localhost/ott/TV.php?mid=".$tvid."'class='w3-bar-item w3-button w3-padding-large w3-hide-small'>Watch Now</a></td>";
        echo "</tr>";
        echo "</tr>";
    }
}
