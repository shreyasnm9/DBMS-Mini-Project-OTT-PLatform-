...
echo "<form method='post' action='movieupdate.php'>";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td style='border: 1px solid black;'><a href='http://localhost/ott/movieupdate.php?mid=".$mid."'class='w3-bar-item w3-button w3-padding-large w3-hide-small'>Edit</a></td>";
        echo "</tr>";
    }
} else {
    echo "0 results";
