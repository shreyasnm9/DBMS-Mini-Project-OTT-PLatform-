...
echo "<form method='post' action='tvdelete.php'>";
echo "<table border='0' style='margin:0 auto'>";
echo "<tr>";
echo "<th style='border: 1px solid black;'>TV_ID</th>";
echo "<th style='border: 1px solid black;'>Show Name</th>";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td style='border: 1px solid black;'><input type='checkbox' name='selected[]' value='". $row["TV_id"] . "'></td>";
        echo "</tr>";
    }
} else {
    echo "0 results";
...
echo "<td colspan='8'>" . "<input type='submit' name = 'deltv' value='Delete'/> ". "</td>";
echo "</tr>";
echo "</table>";
echo "</form>";
