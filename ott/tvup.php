...
echo "<form method='post' action='tvupdate.php'>";
echo "<table border='0' style='margin:0 auto'>";
echo "<tr>";
echo "<th style='border: 1px solid black;'>TV_ID</th>";
echo "<th style='border: 1px solid black;'>TV Name</th>";
echo "<th style='border: 1px solid black;'>Seasons</th>";
echo "<th style='border: 1px solid black;'>episodes</th>";
echo "<th style='border: 1px solid black;'>Release Year</th>";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td style='border: 1px solid black;'>" . $row["TV_id"] . "</td>";
        $tvid = $row["TV_id"];
        echo "<td style='border: 1px solid black;'>" . $row["TV_name"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["seasons"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["no_of_episodes"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["yr_of_release"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["genreTV"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["languageTV"] . "</td>";
        echo "<td style='border: 1px solid black;'>" . $row["tposter"] . "</td>";
        echo "<td style='border: 1px solid black;'><a href='http://localhost/ott/tvupdate.php?tvid=".$tvid."'class='w3-bar-item w3-button w3-padding-large w3-hide-small'>Edit</a></td>";
        echo "</tr>";
    }
} else {
    echo "0 results";
